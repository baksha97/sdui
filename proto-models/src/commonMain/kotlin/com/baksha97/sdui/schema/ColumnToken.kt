...
// Source: com.baksha97.sdui.schema.ColumnToken in sdui.proto
...
public class ColumnToken(
...
) : Message<ColumnToken, Nothing>(ADAPTER, unknownFields) {
  @field:WireField(
    tag = 8,
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is ColumnToken) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "ColumnToken{", separator = ", ", postfix = "}")
  }
  ...
  ): ColumnToken = ColumnToken(id, version, a11y, padding, margin, background, alignment, children,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ColumnToken> = object : ProtoAdapter<ColumnToken>(
      FieldEncoding.LENGTH_DELIMITED, 
      ColumnToken::class, 
      "type.googleapis.com/com.baksha97.sdui.schema.ColumnToken", 
      PROTO_3, 
      null, 
      "sdui.proto"
    ) {
      override fun encodedSize(`value`: ColumnToken): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: ColumnToken) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: ColumnToken) {
        writer.writeBytes(value.unknownFields)
        Token.ADAPTER.asRepeated().encodeWithTag(writer, 8, value.children)
        if (value.alignment != HorizontalAlignment.HORIZONTAL_ALIGNMENT_UNSPECIFIED)
            HorizontalAlignment.ADAPTER.encodeWithTag(writer, 7, value.alignment)
      ...
      override fun decode(reader: ProtoReader): ColumnToken {
        var id: String = ""
        var version: Int = 0
        var a11y: A11y? = null
      ...
      override fun redact(`value`: ColumnToken): ColumnToken = value.copy(
