...
// Source: com.baksha97.sdui.schema.LazyRowToken in sdui.proto
...
public class LazyRowToken(
  ...
  @field:WireField(
    tag = 7,
    adapter = "com.baksha97.sdui.schema.VerticalAlignment#ADAPTER",
    label = WireField.Label.OMIT_IDENTITY,
    schemaIndex = 6,
  )
  public val alignment: VerticalAlignment = VerticalAlignment.VERTICAL_ALIGNMENT_UNSPECIFIED,
  children: List<Token> = emptyList(),
  unknownFields: ByteString = ByteString.EMPTY,
) : Message<LazyRowToken, Nothing>(ADAPTER, unknownFields) {
  @field:WireField(
    tag = 8,
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is LazyRowToken) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "LazyRowToken{", separator = ", ", postfix = "}")
  }
  ...
  public fun copy(
    ...
    alignment: VerticalAlignment = this.alignment,
    children: List<Token> = this.children,
    unknownFields: ByteString = this.unknownFields,
  ): LazyRowToken = LazyRowToken(id, version, a11y, padding, margin, background, alignment,
      children, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<LazyRowToken> = object : ProtoAdapter<LazyRowToken>(
      FieldEncoding.LENGTH_DELIMITED, 
      LazyRowToken::class, 
      "type.googleapis.com/com.baksha97.sdui.schema.LazyRowToken", 
      PROTO_3, 
      null, 
      "sdui.proto"
    ) {
      override fun encodedSize(`value`: LazyRowToken): Int {
        ...
        if (value.background != null) size += Background.ADAPTER.encodedSizeWithTag(6,
            value.background)
        if (value.alignment != VerticalAlignment.VERTICAL_ALIGNMENT_UNSPECIFIED) size +=
            VerticalAlignment.ADAPTER.encodedSizeWithTag(7, value.alignment)
        size += Token.ADAPTER.asRepeated().encodedSizeWithTag(8, value.children)
        return size
      }

      override fun encode(writer: ProtoWriter, `value`: LazyRowToken) {
        ...
        if (value.alignment != VerticalAlignment.VERTICAL_ALIGNMENT_UNSPECIFIED)
            VerticalAlignment.ADAPTER.encodeWithTag(writer, 7, value.alignment)
        Token.ADAPTER.asRepeated().encodeWithTag(writer, 8, value.children)
        writer.writeBytes(value.unknownFields)
      }

      override fun encode(writer: ReverseProtoWriter, `value`: LazyRowToken) {
        writer.writeBytes(value.unknownFields)
        Token.ADAPTER.asRepeated().encodeWithTag(writer, 8, value.children)
        if (value.alignment != VerticalAlignment.VERTICAL_ALIGNMENT_UNSPECIFIED)
            VerticalAlignment.ADAPTER.encodeWithTag(writer, 7, value.alignment)
      ...
      override fun decode(reader: ProtoReader): LazyRowToken {
        var id: String = ""
        var version: Int = 0
        var a11y: A11y? = null
        ...
        var alignment: VerticalAlignment = VerticalAlignment.VERTICAL_ALIGNMENT_UNSPECIFIED
        ...
        val unknownFields = reader.forEachTag { tag ->
          when (tag) {
            ...
            7 -> try {
              alignment = VerticalAlignment.ADAPTER.decode(reader)
      ...
      override fun redact(`value`: LazyRowToken): LazyRowToken = value.copy(
