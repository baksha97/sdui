...
// Source: com.baksha97.sdui.schema.Margin in sdui.proto
...
public class Margin(
...
) : Message<Margin, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "Margin{", separator = ", ", postfix = "}")
  }
  ...
  ): Margin = Margin(all, horizontal, vertical, start, top, end, bottom, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<Margin> = object : ProtoAdapter<Margin>(
      FieldEncoding.LENGTH_DELIMITED, 
      Margin::class, 
      "type.googleapis.com/com.baksha97.sdui.schema.Margin", 
      PROTO_3, 
      null, 
      "sdui.proto"
    ) {
      override fun encodedSize(`value`: Margin): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: Margin) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: Margin) {
        writer.writeBytes(value.unknownFields)
        if (value.bottom != 0) ProtoAdapter.INT32.encodeWithTag(writer, 7, value.bottom)
        if (value.end != 0) ProtoAdapter.INT32.encodeWithTag(writer, 6, value.end)
        if (value.top != 0) ProtoAdapter.INT32.encodeWithTag(writer, 5, value.top)
      ...
      override fun decode(reader: ProtoReader): Margin {
        var all: Int = 0
      ...
      override fun redact(`value`: Margin): Margin = value.copy(
