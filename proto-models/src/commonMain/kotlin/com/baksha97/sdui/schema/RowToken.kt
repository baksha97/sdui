...
// Source: com.baksha97.sdui.schema.RowToken in sdui.proto
...
public class RowToken(
...
) : Message<RowToken, Nothing>(ADAPTER, unknownFields) {
  @field:WireField(
    tag = 8,
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is RowToken) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "RowToken{", separator = ", ", postfix = "}")
  }
  ...
  ): RowToken = RowToken(id, version, a11y, padding, margin, background, alignment, children,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<RowToken> = object : ProtoAdapter<RowToken>(
      FieldEncoding.LENGTH_DELIMITED, 
      RowToken::class, 
      "type.googleapis.com/com.baksha97.sdui.schema.RowToken", 
      PROTO_3, 
      null, 
      "sdui.proto"
    ) {
      override fun encodedSize(`value`: RowToken): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: RowToken) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: RowToken) {
        writer.writeBytes(value.unknownFields)
        Token.ADAPTER.asRepeated().encodeWithTag(writer, 8, value.children)
        if (value.alignment != VerticalAlignment.VERTICAL_ALIGNMENT_UNSPECIFIED)
            VerticalAlignment.ADAPTER.encodeWithTag(writer, 7, value.alignment)
      ...
      override fun decode(reader: ProtoReader): RowToken {
        var id: String = ""
        var version: Int = 0
        var a11y: A11y? = null
      ...
      override fun redact(`value`: RowToken): RowToken = value.copy(
